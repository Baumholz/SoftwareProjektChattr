...
import com.example.david.chattr.editing.add_contacts.NewManualContactActivity;
import com.example.david.chattr.editing.add_contacts.NfcBeamActivity;
import com.example.david.chattr.editing.add_contacts.ShowQrActivity;
...
public class NewContactFragment extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Button manualButton = view.findViewById(R.id.manuallButton);
        ...
        manualButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(), NewManualContactActivity.class);
